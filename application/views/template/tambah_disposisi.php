	...
	<div class="content">
		...
		<div class="module">
			...
			<div class="module-body">
				...
				<?php echo form_open_multipart('disposisi/add/'.$uri3, 'class="form-horizontal row-fluid"') ?>
				<div class="control-group">
					<label class="control-label">Tujuan Disposisi <span class="text-error">*</span></label>
					<div class="controls">
						<input type="text" id="tujuan-disposisi" name="tujuan" class="span5" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span5" id="tgl_start" name="batas_waktu">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea type="text" name="isi_disposisi" class="span8"></textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea type="text" name="catatan" class="span8"></textarea>
