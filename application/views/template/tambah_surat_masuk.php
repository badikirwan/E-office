					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
								<?php echo form_open_multipart('surat_masuk/add', 'class="form-horizontal row-fluid"') ?>
								<div class="control-group">
										<label class="control-label">Nomor Agenda <span class="text-error">*</span></label>
										<div class="controls">
												<input type="text" name="no_agenda" class="span5" value="<?php echo get_noagenda()?>">
								...
								<div class="control-group">
										...
										<div class="controls">
												<input type="text" name="no_surat" class="span5" value="<?php echo set_value('no_surat')?>">
								...
								<div class="control-group">
										...
										<div class="controls">
												<input type="text" name="asal_surat" class="span8" value="<?php echo set_value('asal_surat')?>">
								...
								<div class="control-group">
										...
										<div class="controls">
												<textarea type="text" class="span8" name="isi_ringkas"><?php echo set_value('isi_ringkas')?></textarea>
								...
								<div class="control-group">
										...
										<div class="controls">
												<input type="text" id="kode_klas" name="kode_klas" class="span5" value="<?php echo set_value('kode_klas')?>">
								...
								<div class="control-group">
										...
										<div class="controls">
												<input type="text" name="indeks" class="span5" value="<?php echo set_value('indeks')?>">
												<br />
								...
								<div class="control-group">
										...
										<div class="controls">
												<input type="text" id="tgl_start" name="tgl_surat" class="span5" value="<?php echo set_value('tgl_surat')?>">
												<br />
								...
								<div class="control-group">
										...
										<div class="controls">
												<textarea type="text" class="span8" name="keterangan"><?php echo set_value('keterangan')?></textarea>
