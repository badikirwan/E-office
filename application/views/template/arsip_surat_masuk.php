	              ...
	              <tbody>
                        ...
                        <td><?= $key->dari?></td>
                            ...
                            <a class="btn btn-default btn-small" href="<?= base_url('klasifikasi/edit/'.$key->id)?>" data-toggle="tooltip" title="" data-original-title="Edit"><i class="icon-eye-open"></i></a>
														<a class="btn btn-default btn-small" href="<?= base_url('upload/surat_masuk/'.$key->file)?>" target="_blank" data-toggle="tooltip" title="" data-original-title="Edit"><i class="icon-download-alt"></i></a>
